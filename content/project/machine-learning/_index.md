...
summary: 'Signal understanding, perception, and decision support models spanning CNNs, Transformers, AutoML, and multi-modal learning.'
description: 'This category aggregates every machine learning effort in the BCML Lab—including classic data-mining pipelines, explainable deep nets, and AI systems that power our healthcare and wearable platforms.'
view: 2
---
...
- [Neural Networks for Human Action Recognition](/project/machine-learning/human-action-recognition/)
- [Multimodal Sleep State Estimation](/project/machine-learning/multimodal-sleep-state/)
- [Deep-ACTINet: End-to-End Sleep/Wake Detection](/project/machine-learning/deep-actinet/)
- [Deep ECGNet: Ultra Short-Term Stress Monitoring](/project/machine-learning/deep-ecgnet/)
- [Bio-signal Analysis with Deep Learning](/project/machine-learning/biosignal-deep-learning/)
- [Automatic Image & Data Extraction](/project/machine-learning/automatic-image-data-analysis/)
