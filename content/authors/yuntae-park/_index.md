...
# Role/position
role: Researcher, Infinitree

# Organizations/Affiliations
organizations:
  - name: Infinitree
    url: 'https://www.infinitree.ai/'

# Short bio (displayed in user profile at end of posts)
bio: His research interests include machine learning algorithms, deep learning, and reinforcement learning.
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:parkjow15@naver.com'
...
- **Yuntae Park**, Unang Sunarya, Geunbo Yang, Choongseop Lee, Jaewoo Baek, Suwhan Baek, Cheolsoo Park, "Classification using a Spiking Neural Network: A Review", *IEIE Transactions on Smart Processing & Computing*, 2023-02 (KCI, vol.12 No.01)
