...
- 박철수, **이희준**, 석우준 전태욱, "웨어러블 디바이스가 근전도 패턴을 이용하여 사용자가 원하는 액션을 수행하는 방법 (Method for performing desired action of user using EMG pattern by wearable device)", 출원번호: 10-2018-0075853, Jun. 2018

- 박철수 **이희준** 여민수 한승우 김규민, "사용자의 집중도를 판단하는 방법 및 이를 위한 웨어러블 디바이스 (Wearable device and method for determining concentration degree of user)", 출원번호: 10-2018-0060627, May 2018

- 박철수, 석우준, 여민수, **이희준**, 김영철, 전태욱, "사용자의 졸음의 정도 혹은 집중력의 정도를 측정하기 위한 방법 및 이를 위한 웨어러블 디바이스 (Wearable device and method for measuring the degree of drowsiness or concentration of the user)", 출원번호: 10-2017-0058645, May 2017

## Awards

- **우수 포스터상**, 대한의용생체공학회 춘계학술대회, May 2018
  - "딥러닝 뇌파 분석을 통한 멀티미디어 강의 시청 집중도 분류"

- **Best Poster Award**, IBEC 2016, Nov. 2016
  - "Effects of visual and auditory delta band stimuli on sleep"

- **KWIX 우수상**, 2016
  - "소리와 빛 자극이 수면 중에 미치는 영향에 대한 연구" (with 여민수)

- **My Capstone 장려상**, 2016
  - "소리와 빛 자극이 수면 중에 미치는 영향에 대한 연구" (with 여민수)
